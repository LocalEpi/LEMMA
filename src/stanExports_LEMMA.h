...
private:
        ...
        double duration_vaccinated;
        double duration_natural;
        int Su;
        int Sv;
        int Eu;
        int Ev;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "duration_vaccinated", "double", context__.to_vec());
            duration_vaccinated = double(0);
            vals_r__ = context__.vals_r("duration_vaccinated");
            pos__ = 0;
            duration_vaccinated = vals_r__[pos__++];
            check_greater_or_equal(function__, "duration_vaccinated", duration_vaccinated, 1.0);
            current_statement_begin__ = 68;
            context__.validate_dims("data initialization", "duration_natural", "double", context__.to_vec());
            duration_natural = double(0);
            vals_r__ = context__.vals_r("duration_natural");
            pos__ = 0;
            duration_natural = vals_r__[pos__++];
            check_greater_or_equal(function__, "duration_natural", duration_natural, 1.0);
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int it = 1; it <= (nt - 1); ++it) {
                ...
                stan::math::assign(S_lostv, ((1.0 / duration_vaccinated) * get_base1(x, Sv, it, "x", 1)));
                current_statement_begin__ = 222;
                stan::math::assign(R_lostv, ((1.0 / duration_vaccinated) * get_base1(x, Rlivev, it, "x", 1)));
                current_statement_begin__ = 223;
                stan::math::assign(R_lostnatu, ((1.0 / duration_natural) * get_base1(x, Rliveu, it, "x", 1)));
                current_statement_begin__ = 224;
                stan::math::assign(R_lostnatv, ((1.0 / duration_natural) * get_base1(x, Rlivev, it, "x", 1)));
                ...
                stan::model::assign(x, 
                            ...
                            ((((((get_base1(x, Rliveu, it, "x", 1) + newrecu_mild) + newrec_mod) + (leave_icu * (1 - frac_mort))) - newRlivev) + R_lostv) - R_lostnatu), 
                            "assigning variable x");
