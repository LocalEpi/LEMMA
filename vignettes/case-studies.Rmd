...
```
Note that the "User's Prior Projection" scenario is not compatible with the given bounds. See FAQ.md for more details on what this means. 
...
```
To get fast feedback on just the User's Prior Projection scenario, set main.iterations to 1.
